  ...
  auth: {
    ...
    errors: {
      ...
      reasons: {
        ...
        EMAIL_AUTH_DISABLED: 'Email registration and password login are currently unavailable.',
  ...
  admin: {
    ...
    settings: {
      ...
      registration: {
        ...
        emailAuth: 'Email Registration',
        emailAuthHint: 'Control email/password registration, login, and registration verification codes',
