export default {
  ...
  auth: {
    ...
    emailLoginDisabled: '邮箱密码登录暂未开放，请使用其他登录方式或联系管理员。',
    emailRegistrationDisabled: '邮箱注册暂未开放，请使用其他登录方式或联系管理员。',
    emailLabel: '邮箱',
