...
const userNavItems = computed((): NavItem[] => {
  const items: NavItem[] = [
    ...
    { path: '/quotas', label: t('nav.mySubscriptions'), icon: CreditCardIcon, hideInSimpleMode: true },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/quotas', label: t('nav.subscriptions'), icon: CreditCardIcon, hideInSimpleMode: true },
